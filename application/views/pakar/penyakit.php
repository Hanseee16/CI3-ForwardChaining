                                    ...
                                    <?php foreach ($penyakit as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-sm btn-danger" onclick="hapusData('<?= base_url('pakar/hapus_penyakit/' . $value['kode_penyakit']); ?>')">
    ...
    <div class="modal fade" id="tambah" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <?= form_open('pakar/tambah_penyakit'); ?>
        ...
        <div class="modal fade" id="edit<?= $value['kode_penyakit']; ?>" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <?= form_open('pakar/edit_penyakit/' . $value['kode_penyakit']) ?>
