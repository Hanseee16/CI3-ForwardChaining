                                ...
                                <tbody>
                                    <?php foreach ($penyakit as $p) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if ($has_relasi): ?>
                                                    <a href="<?= base_url('pakar/edit_relasi/' . $p['kode_penyakit']); ?>" class="btn btn-sm btn-warning">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?= base_url('pakar/tambah_relasi/' . $p['kode_penyakit']); ?>" class="btn btn-sm btn-primary">
