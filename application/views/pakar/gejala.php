                                    ...
                                    <?php foreach ($gejala as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-sm btn-danger" onclick="hapusData('<?= base_url('pakar/hapus_gejala/' . $value['kode_gejala']); ?>')">
        ...
        <div class="modal fade" id="edit<?= $value['kode_gejala']; ?>" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <?= form_open('pakar/edit_gejala/' . $value['kode_gejala']) ?>
