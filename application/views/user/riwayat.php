                                ...
                                <tbody>
                                    <?php foreach ($konsultasi as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $value['diagnosa_ke']; ?></td>
                                            <td class="text-center"><?= tanggalIndonesia($value['tanggal_diagnosa']); ?></td>
                                            <td class="text-center">
                                                <a href="<?= base_url('user/detail_riwayat/' . $value['id_user'] . '/' . $value['diagnosa_ke']); ?>" class="btn btn-sm btn-secondary">
