                                    ...
                                    <?php foreach ($konsultasi as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('user/detail_data_konsultasi/' . $value['id_user'] . '/' . $value['konsultasi_ke']); ?>" class="btn btn-sm btn-secondary">
                                                    <i class="bi bi-eye-fill"></i>
                                                </a>
                                                <button class="btn btn-sm btn-danger" onclick="hapusData('<?= base_url('user/hapus_konsultasi/' . $value['id_user'] . '/' . $value['konsultasi_ke']); ?>')">
