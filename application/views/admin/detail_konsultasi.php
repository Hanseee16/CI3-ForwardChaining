    <main id="main" class="main">
        <div class="pagetitle d-flex justify-content-between align-items-center">
            <div>
                ...
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/konsultasi'); ?>">Data Konsultasi</a></li>
                        <li class="breadcrumb-item active">Detail Konsultasi</li>
                    </ol>
                </nav>
            </div>
            <div>
                <a href="<?= base_url('admin/print_konsultasi/' . $id_user . '/' . $konsultasi_ke); ?>" target="_blank" class="btn btn-sm btn-danger">Cetak Data</a>
                <a href="<?= base_url('admin/konsultasi'); ?>" class="btn btn-sm btn-secondary">Kembali</a>
            </div>
        </div>
